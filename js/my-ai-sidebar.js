    ...
    window.wp.plugins.registerPlugin("my-ai-sidebar", {
        render: () => {
            ...
            var optionsElement = foundationModels.map(modelId => {
                return element.createElement('option', { value: modelId }, modelId);
            });
            var selectElement = element.createElement('select', {
            ...
            var labelSelectModelElement = element.createElement('label', { display: 'block' }, 'Select foundation model:');
            var labelPromptElement = element.createElement('label', { display: 'block' }, 'Input prompt:');
            var inputPromptElement = element.createElement('textarea', {
            ...
            var buttonElement = element.createElement('button', {
            ...
            var spanTemperatureElement = element.createElement('span', {
                id: 'my_ai_temp_span', style: { fontWeight: 'bold' },
            }, temperatureState.default);
            var labelTemperatureElement = element.createElement('label', { display: 'block' }, 
                'Temperature: ', spanTemperatureElement);
            var inputTemperatureElement = element.createElement('input', {
            ...
            var spanTopPElement = element.createElement('span', {
                id: 'my_ai_top_p_span', style: { fontWeight: 'bold' },
            }, topPState.default);
            var labelTopPElement = element.createElement('label', { display: 'block' },
                'Top P: ', spanTopPElement);
            var inputTopPElement = element.createElement('input', {
            ...
            var spanMaxTokensElement = element.createElement('span', {
                id: 'my_ai_max_tokens_span', style: { fontWeight: 'bold' },
                }, maxTokensState.default);
            var labelMaxTokensElement = element.createElement('label', { display: 'block' },
                'Max Tokens: ', spanMaxTokensElement);
            var inputMaxTokensElement = element.createElement('input', {
            ...
            var modelConfigElement = element.createElement('div', {
                id: 'my_ai_model_config', display: 'block', style: { marginBottom: '10px' }
            }, ...modelConfigElements)

            var myAiElement = element.createElement('div', {
            ...
            var pluginInfo = element.createElement(window.wp.editPost.PluginSidebar, {
